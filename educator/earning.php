...
if(isset($_POST['submit'])){
    ...
    $sql = "SELECT tbl_course.price
        ...
        AND tbl_enroll.order_date BETWEEN '$start_date' AND '$end_date'";
    ...
    ?>
        ...
        <div class="card text-white bg-info" style="max-width: 20rem; margin-left:7rem; margin-top:2rem">
            <div class="card-header text-dark">Earnings from <?php echo $start_date; ?> to <?php echo $end_date ?></div>
                <div class="card-body">
                    <h4 class="card-title">
                        NRs. <?php echo $totalEarnings; ?>
                    </h4>
                </div>
            </div>
        </div>
