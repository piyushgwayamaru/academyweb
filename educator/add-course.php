	...
	<div class="wrapper">
		...
		<?php  
			...
			if(isset($_POST['submit']))
			{
				...
				$sql2 =  "INSERT INTO tbl_course (category_id, image, title, preview_video,   language, description, active, price, discount)
				VALUES ('$category', '$image_name', '$title', '$preview_video_name', '$language', '$description', '$active', '$price','$discount')";
